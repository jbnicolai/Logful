 ...
 * @see       {@link http://en.wikipedia.org/wiki/Syslog#Severity_levels
 *            |Syslog - Severity levels} for more information
...
Logful.severities = Object.freeze(Logful.severities)
 ...
 *
 * @param     {String}  handler   The handler name to load - must be a valid handler in the
 *                                lib/handlers folder
 * @param     {Object}  opts      Configuration options - these will be passed directly to the
 *                                logging handler
 * @return    {Logful}
 */
 ...
 * @param  {String|Error} message   The message to be logged or an instance of Error
 * @fires  Logful#entry
 * @return {Logful}
 */
