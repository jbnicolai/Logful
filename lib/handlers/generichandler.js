 ...
 * @param   {Object}    opts.formats.message    The default message format
 * @param   {Object}    opts.formats.timestamp  The default timestamp format
 */
 ...
 * @param     {String}        template  The string template which specifies how the data should be represented
